 ...
 */
public abstract class MPermissionsFragment extends Fragment implements IMPermissions
{
    @Override
    ...
    private void startRequestMPermissions()
    {
        ...
        final ArrayList<String> deniedPermissions = MPermissionsUtil.getDeniedPermissions(getActivity(), allPermissions);
            ...
            for (String permission : allPermissions)
            {
                if (shouldShowRequestPermissionRationale(permission))
                {
                    ...
                    builder.setPositiveButton(tips.getPositiveButton(), new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            requestPermissions(allPermissions.toArray(new String[allPermissions.size()]), MPermissionsUtil.REQUEST_STATUS_CODE);
                        }
                    });
